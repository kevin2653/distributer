      ...
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <el-table :data="commissionData" tooltip-effect="dark" border style="width: 100%" >
            <el-table-column label="产品类别" prop="dInfo.distributerName" align="center">
            </el-table-column>
            <el-table-column label="产品名称" prop="order.userName" align="center">
            </el-table-column>
            ...
            <el-table-column label="服务人次" prop="order.orderPayTime" align="center">
            </el-table-column>
          </el-table>
        </div>
      </el-col>
