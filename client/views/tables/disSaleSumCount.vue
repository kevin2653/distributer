<template>
  <div style="min-height: 1200px">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="2">
        <div class="grid-content bg-purple">
          <el-button round @click="handleDownload">导出报表</el-button>
        </div>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <el-table :data="commissionData" tooltip-effect="dark" border style="width: 100%" >
            <el-table-column label="代理商编号" prop="dInfo.distributerName" align="center">
            </el-table-column>
            <el-table-column label="代理商名称" prop="order.userName" align="center">
            </el-table-column>
            <el-table-column label="渠道分类" prop="order.orderType" align="center">
            </el-table-column>
            <el-table-column label="在线支付总金额(元)" prop="order.orderAmount" align="center">
            </el-table-column>
            <el-table-column label="代付总金额(元)" prop="commissionAmount" align="center">
            </el-table-column>
    ...
    methods: {
      handleDownload () {
        ...
        require.ensure([], () => {
          ...
          const title = '代理商销售汇总统计'
          const tHeader = ['代理商编号', '代理商名称', '渠道分类', '在线支付总金额(元)', '代付总金额(元)', '排名']
          const filterVal = ['settlementYear', 'settlementYear', 'settlementYear', 'settlementYear', 'commissionAmount', 'settlementYear']
          console.log('打印当前表格数据')
          console.log(this.commissionData)
          const list = this.commissionData
          const data = this.formatJson(filterVal, list)
          console.log('打印当前excel表格解析')
          console.log(data)
