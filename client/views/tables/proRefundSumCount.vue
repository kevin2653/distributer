      ...
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <el-table :data="commissionData" tooltip-effect="dark" border style="width: 100%" >
            <el-table-column label="产品名称" prop="dInfo.distributerName" align="center">
            </el-table-column>
            <el-table-column label="产品类别" prop="order.orderAmount" align="center">
            </el-table-column>
            <el-table-column label="退款金额" prop="commissionAmount" align="center">
            </el-table-column>
