      ...
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <el-table :data="commissionData" tooltip-effect="dark" border style="width: 100%" >
            <el-table-column label="目的地" prop="dInfo.distributerName" align="center">
            </el-table-column>
            <el-table-column label="订单数量" prop="order.orderAmount" align="center">
            </el-table-column>
            <el-table-column label="服务人次" prop="commissionAmount" align="center">
            </el-table-column>
