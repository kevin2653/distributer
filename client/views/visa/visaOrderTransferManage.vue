      ...
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <el-table :data="orderData" tooltip-effect="dark" border style="width: 100%" >
            ...
            <el-table-column label="申请人姓名" prop="linkMan" align="center">
            </el-table-column>
            <el-table-column label="退款金额(元)" prop="linkTel" align="center">
            </el-table-column>
            <el-table-column label="赔偿金额(元)" prop="amount" align="center">
            </el-table-column>
            <el-table-column label="状态" prop="statusStr" align="center">
            </el-table-column>
            <el-table-column label="退款原因" prop="statusStr" align="center">
            </el-table-column>
            <el-table-column label="申请退款时间" prop="addTime" align="center">
            </el-table-column>
            ...
            <el-table-column align="center" width="340" label="操作">
              <template slot-scope="scope" center>
                <el-button round size="mini" @click="seeDetails(scope.$index, scope.row)">审  核</el-button>
                <el-button round size="mini" @click="cancelOrder(scope.$index, scope.row)" disable v-if="scope.row.statusId !== 115&& scope.row.statusId !== 200">查看订单</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
